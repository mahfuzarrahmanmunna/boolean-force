                                ...
                                <div key={link.name} className="relative group">
                                    ...
                                    {link.name === "About" && (
                                        <div className="absolute left-0 mt-2 hidden group-hover:block">
                                            <div className="bg-slate-800/95 backdrop-blur-md rounded-md shadow-lg py-2 w-44 border border-slate-700/50">
                                                <Link
                                                    href="/about"
                                                    className="block px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-slate-700/50 transition-all"
                                                >
                                                    About Us
                                                </Link>
                                                <Link
                ...
                >
                    {navLinks.map((link) => (
                        <div key={link.name}>
                            ...
                            {/* ✅ Show About dropdown under mobile too */}
                            {link.name === "About" && (
                                <div className="pl-6">
                                    <Link
                                        href="/about"
