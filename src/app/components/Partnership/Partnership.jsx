  ...
  const partnershipOptions = [
    {
      ...
      description:
        "Partner with us to offer comprehensive IT solutions to your clients. White-label our services and expand your portfolio.",
      features: [
        "40% Revenue Share",
      ...
      bgPattern:
        "radial-gradient(circle at 10% 20%, rgba(59, 133, 254, 0.1) 0%, transparent 50%)",
      accentColor: "#3B85FE",
    },
    {
      id: 2,
      ...
      description:
        "Join our elite network of freelancers and work on exciting projects with guaranteed payments and professional growth.",
      features: [
      ...
      buttonColor: "from-[#3B85FE] to-[#2B6FDE]",
      bgPattern:
        "radial-gradient(circle at 90% 80%, rgba(169, 219, 220, 0.1) 0%, transparent 50%)",
      accentColor: "#A9DBDC",
    },
    {
      id: 3,
      ...
      description:
        "Integrate your technology solutions with our platform. API partnerships and custom integrations available.",
      features: [
      ...
      buttonColor: "from-[#3B85FE] to-[#2B6FDE]",
      bgPattern:
        "radial-gradient(circle at 50% 50%, rgba(59, 133, 254, 0.1) 0%, transparent 50%)",
      accentColor: "#3B85FE",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join forces with BooleanForce to expand your reach, enhance your
            services, and create mutual growth opportunities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          {partnershipOptions.map((option) => (
            <div
              key={option.id}
              className={`relative group backdrop-blur-lg bg-white/5 rounded-2xl shadow-xl overflow-hidden transform transition-all duration-500 hover:scale-105 border border-white/10 hover:border-white/20 ${
          ...
          <div className="relative z-10">
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#A9DBDC] mb-2">
                  500+
                </div>
