        ...
        <section className="py-20 px-4 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    ...
                    <button className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/25 transform hover:scale-105">
                        Contact Us
                    </button>
                </motion.div>
            </div>
