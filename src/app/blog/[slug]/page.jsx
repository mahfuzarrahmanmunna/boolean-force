                            ...
                            {blogComments.map((comment) => (
                                <div key={comment.id} className="flex">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <button className="text-sm text-blue-600 hover:text-blue-800 mt-2">Reply</button>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {relatedPosts.map((post) => (
                            <div key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden transform hover:scale-105 hover:shadow-xl transition-all duration-300">
