...
export async function POST(request) {
    try {
        ...
        // Check if project exists and is assigned to this team
        ...
        if (!project) {
            return NextResponse.json(
                { success: false, error: "Project not found or not assigned to your team." },
                { status: 404 }
            );
        }
        ...
        // Update project to submitted status
        const updateData = {
            status: 'submitted',
