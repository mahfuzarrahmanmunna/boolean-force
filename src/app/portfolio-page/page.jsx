                        ...
                        >
                            <div className="relative h-64 overflow-hidden">
                                ...
                                >
                                    ...
                                    <button className="flex items-center text-white font-medium text-sm hover:text-blue-400 transition-colors">
                                        View Details
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center justify-between">
                                    <button className="text-blue-400 hover:text-white transition-colors duration-300 flex items-center text-sm font-medium">
                                        <ExternalLink className="w-4 h-4 mr-1" />
                                        Live Preview
                                    </button>
                                    <button className="text-purple-400 hover:text-white transition-colors duration-300 flex items-center text-sm font-medium">
