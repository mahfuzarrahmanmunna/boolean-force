...
const companyServices = [
  {
    ...
    title: "POS Systems",
    description:
      "Streamline retail operations with our advanced point-of-sale solutions",
    icon: <FaCreditCard />,
    color: "bg-blue-500",
    features: [
  ...
  },
  {
    ...
    description:
      "Create memorable brand presence that resonates with your audience",
    icon: <FaPalette />,
    color: "bg-purple-500",
    features: [
      "Logo Design",
  ...
  },
  {
    ...
    description:
      "Integrate business processes with our comprehensive ERP systems",
    icon: <FaChartBar />,
    color: "bg-green-500",
    features: [
      "Finance Management",
  ...
  },
  {
    ...
    description:
      "Build responsive websites that drive engagement and conversions",
    icon: <FaGlobe />,
    color: "bg-indigo-500",
    features: [
      "Custom Web Apps",
  ...
  },
  {
    ...
    description:
      "Migrate to cloud infrastructure for scalability and efficiency",
    icon: <FaCloud />,
    color: "bg-yellow-500",
    features: [
      "Cloud Migration",
...
const portfolioProjects = [
  {
    ...
    description:
      "Complete point-of-sale solution for retail chains with inventory management and analytics.",
  ...
  },
  {
    ...
    description:
      "Complete brand redesign including logo, color palette, and marketing materials.",
  ...
  },
  {
    ...
    description:
      "Comprehensive ERP solution integrating finance, HR, and supply chain management.",
  ...
  },
  {
    ...
    description:
      "Cross-platform mobile app for food delivery with real-time tracking and payments.",
  ...
  },
  {
    ...
    description:
      "Enterprise cloud migration solution with automated deployment and monitoring.",
...
const companyValues = [
  ...
  },
  {
    ...
    title: "Quality",
    description:
      "We deliver excellence in every project, ensuring robust and reliable solutions.",
  },
  {
    icon: <FaRocket />,
    title: "Efficiency",
    description:
      "We optimize processes and implement solutions that enhance operational efficiency.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section
        id="projects"
        ref={portfolioRef}
        className="py-20 px-6 bg-gray-800 bg-opacity-50 -mt-8 min-h-screen"
      >
        ...
        {/* ScrollStack Component with props */}
        <ScrollStack
      ...
      <section
        id="services"
        className="relative py-24 px-6 bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 overflow-hidden"
      >
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <div className="text-center mb-14 -mt-8">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              We craft end-to-end technology solutions designed to help your
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 -mt-8">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                At{" "}
                <span className="font-semibold text-white">booleanforce</span>,
                we specialize in crafting next-gen digital solutions that
                empower businesses to move faster, scale smarter, and innovate
                continuously.
              </p>

              <p className="text-gray-400 text-lg leading-relaxed">
                With over a decade of experience, our team of developers,
                designers, and tech strategists work hand-in-hand with clients
                to build products that inspire confidence and drive measurable
                results.
              </p>
              ...
              <div className="flex gap-5 pt-4">
                <a
                  href="#"
                  className="p-3 rounded-full bg-gray-700/50 hover:bg-blue-600 transition-all duration-300 text-white shadow-lg"
                >
                  <FaGithub size={22} />
                </a>
                <a
      ...
      <section className="relative py-24 px-6 bg-gradient-to-b from-gray-900 via-gray-950 to-gray-900 overflow-hidden -mt-12">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          <div className="text-center mb-14 -mt-8">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              What our amazing clients say about working with{" "}
              <span className="text-blue-400 font-semibold">booleanforce</span>
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {testimonials.map((testimonial) => (
              ...
              >
                {/* Quotation Mark */}
                <div className="absolute -top-4 -left-4 text-6xl text-blue-500/20 select-none">
                  “
                </div>
      ...
      <section className="relative py-24 px-6 bg-gray-900 overflow-hidden -mt-12">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="text-center mb-14 -mt-8">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto  ">
              We're not just another tech company we are your strategic partner
      ...
      <section
        id="contact"
        className="relative py-24 px-6 bg-gray-900 overflow-hidden -mt-12"
      >
