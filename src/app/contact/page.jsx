...
const ContactPage = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: "🎨",
      description: "Create memorable brand presence",
    },
    {
      id: "erp",
  ...
  const jsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "BooleanForce",
    image: "https://booleanforce.com/logo.png", // Replace with actual logo URL
    description:
      "BooleanForce specializes in POS Systems, ERP Software, Web Development, and Branding in Dhaka.",
    address: {
      "@type": "PostalAddress",
      streetAddress:
        "House - SA- 23, (2nd floor), Adarsha Nagar Road, Madda Badda",
    ...
    geo: {
      "@type": "GeoCoordinates",
      latitude: 23.754, // Approximate coordinates for Madda Badda
      longitude: 90.4167,
    },
    url: "https://booleanforce.com/contact",
    telephone: "+8801817886592",
    email: "consult@booleanforce.com",
  ...
  return (
    <>
      <Head>
        <title>Contact BooleanForce | IT & Software Solutions in Dhaka</title>
        <meta
          name="description"
          content="Visit BooleanForce at House - SA- 23, Adarsha Nagar Road, Madda Badda, Dhaka 1212. We provide POS, ERP, Web Development, and Branding services. Call us at 01817886592."
        />
        <meta
          name="keywords"
          content="BooleanForce, Web Development Dhaka, POS Software Bangladesh, ERP Solutions Dhaka, IT Company Madda Badda"
        />
        ...
        <meta property="og:url" content="https://booleanforce.com/contact/" />
        <meta
          property="og:title"
          content="Contact BooleanForce | IT & Software Solutions in Dhaka"
        />
        <meta
          property="og:description"
          content="Get in touch with BooleanForce for professional software solutions in Madda Badda, Dhaka."
        />
        <meta
          property="og:image"
          content="https://booleanforce.com/og-image.jpg"
        />
        ...
        <meta
          ...
          content="https://booleanforce.com/contact/"
        />
        <meta
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <div className="container mx-auto px-6">
              <div className="max-w-3xl">
                <div className="overflow-hidden">
                  <h1
                    id="hero-heading"
                    className={`text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 transform transition-all duration-1000 ${
                      activeSlide >= 0
                ...
                <div className="overflow-hidden">
                  <p
                    className={`text-lg md:text-xl text-gray-300 mb-6 transform transition-all duration-1000 delay-300 ${
                      activeSlide >= 0
                        ? "translate-y-0 opacity-100"
                        : "translate-y-10 opacity-0"
                    }`}
                ...
                <div className="overflow-hidden">
                  <div
                    className={`flex flex-col sm:flex-row gap-3 md:gap-4 transform transition-all duration-1000 delay-500 ${
                      activeSlide >= 0
                        ? "translate-y-0 opacity-100"
                        : "translate-y-10 opacity-0"
                    }`}
          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                We specialize in creating innovative solutions that drive
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {services.map((service) => (
                <div
                  key={service.id}
                  className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group"
                >
                  <div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
                {formStatus.submitted && (
                  <div
                    className={`p-4 rounded-lg mb-6 flex items-center ${formStatus.success ? "bg-green-500/20 text-green-100" : "bg-red-500/20 text-red-100"}`}
                  >
                    {formStatus.success ? (
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-300 mt-1">
                          House - SA- 23, (2nd floor)
                          <br />
                          Adarsha Nagar Road, Madda Badda
                          <br />
                          Dhaka 1212
                        </p>
                      </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <a
                          href="tel:+8801817886592"
                          className="text-gray-300 mt-1 hover:text-white transition-colors"
                        >
                          01817886592
                        </a>
                      </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <a
                          href="mailto:consult@booleanforce.com"
                          className="text-gray-300 mt-1 hover:text-white transition-colors"
                        >
                          consult@booleanforce.com
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <details className="group">
                      ...
                      <p className="text-gray-300 mt-2 pl-4">
                        ...
                        website might take 4-6 weeks, while a complex ERP system
                    ...
                    <details className="group">
                      ...
                      <p className="text-gray-300 mt-2 pl-4">
                        Yes, we offer various support packages including
                        maintenance, updates, and technical assistance after
                        project completion.
                      </p>
                    </details>
                    <details className="group">
                      ...
                      <p className="text-gray-300 mt-2 pl-4">
                        Absolutely! We specialize in integrating new solutions
                        with existing systems to ensure seamless operations.
                      </p>
                    </details>
                  </div>
                </div>
        ...
        <section className="py-16 px-6" aria-labelledby="map-heading">
          <div className="container mx-auto">
            <div className="text-center mb-12">
              <h2
                id="map-heading"
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-2 border border-white/20 overflow-hidden">
              <div className="relative h-96 md:h-[500px] rounded-xl overflow-hidden">
                {/* Updated Map for Dhaka Address */}
                <iframe
                  src="https://maps.google.com/maps?q=House%20SA-23%2C%20Adarsha%20Nagar%20Road%2C%20Madda%20Badda%2C%20Dhaka%201212&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
                  ...
                  title="BooleanForce Office Location Map"
                ></iframe>
              </div>
            </div>
          </div>
